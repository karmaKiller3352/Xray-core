...
import (
	protocol "github.com/karmaKiller3352/Xray-core/common/protocol"
...
func (x *DefaultUser) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DefaultUser) ProtoMessage() {}

func (x *DefaultUser) ProtoReflect() protoreflect.Message {
	mi := &file_proxy_vless_inbound_config_proto_msgTypes[1]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DefaultUser.ProtoReflect.Descriptor instead.
func (*DefaultUser) Descriptor() ([]byte, []int) {
	return file_proxy_vless_inbound_config_proto_rawDescGZIP(), []int{1}
}

func (x *DefaultUser) GetLevel() uint32 {
	if x != nil {
		return x.Level
	}
	return 0
...
func (x *DefaultUser) GetFlow() string {
	if x != nil {
		return x.Flow
	}
	return ""
...
func (x *DefaultUser) GetEncryption() string {
	if x != nil {
		return x.Encryption
	}
	return ""
...
type APIAuth struct {
	...
	MaxConnections uint32                 `protobuf:"varint,3,opt,name=maxConnections,proto3" json:"maxConnections,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *APIAuth) GetMaxConnections() uint32 {
	if x != nil {
...
type Config struct {
	...
	DefaultUser   *DefaultUser `protobuf:"bytes,4,opt,name=defaultUser,proto3" json:"defaultUser,omitempty"`
	ApiAuth       *APIAuth     `protobuf:"bytes,5,opt,name=apiAuth,proto3" json:"apiAuth,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Config) GetDefaultUser() *DefaultUser {
	if x != nil {
...
const file_proxy_vless_inbound_config_proto_rawDesc = "" +
	...
	"\x04xver\x18\x06 \x01(\x04R\x04xver\"W\n" +
	"\vDefaultUser\x12\x14\n" +
	...
	"\x0emaxConnections\x18\x03 \x01(\rR\x0emaxConnections\"\xa6\x02\n" +
	"\x06Config\x124\n" +
	"\aclients\x18\x01 \x03(\v2\x1a.xray.common.protocol.UserR\aclients\x12\x1e\n" +
	"\n" +
	"decryption\x18\x02 \x01(\tR\n" +
	"decryption\x12@\n" +
	"\tfallbacks\x18\x03 \x03(\v2\".xray.proxy.vless.inbound.FallbackR\tfallbacks\x12G\n" +
	"\vdefaultUser\x18\x04 \x01(\v2%.xray.proxy.vless.inbound.DefaultUserR\vdefaultUser\x12;\n" +
	"\aapiAuth\x18\x05 \x01(\v2!.xray.proxy.vless.inbound.APIAuthR\aapiAuthBu\n" +
	"\x1ccom.xray.proxy.vless.inboundP\x01Z8github.com/karmaKiller3352/Xray-core/proxy/vless/inbound\xaa\x02\x18Xray.Proxy.Vless.Inboundb\x06proto3"
...
var file_proxy_vless_inbound_config_proto_goTypes = []any{
	...
	(*DefaultUser)(nil),   // 1: xray.proxy.vless.inbound.DefaultUser
	(*APIAuth)(nil),       // 2: xray.proxy.vless.inbound.APIAuth
	(*Config)(nil),        // 3: xray.proxy.vless.inbound.Config
	(*protocol.User)(nil), // 4: xray.common.protocol.User
}
var file_proxy_vless_inbound_config_proto_depIdxs = []int32{
	4, // 0: xray.proxy.vless.inbound.Config.clients:type_name -> xray.common.protocol.User
	0, // 1: xray.proxy.vless.inbound.Config.fallbacks:type_name -> xray.proxy.vless.inbound.Fallback
	1, // 2: xray.proxy.vless.inbound.Config.defaultUser:type_name -> xray.proxy.vless.inbound.DefaultUser
	2, // 3: xray.proxy.vless.inbound.Config.apiAuth:type_name -> xray.proxy.vless.inbound.APIAuth

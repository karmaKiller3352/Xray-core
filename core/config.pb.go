...
import (
	serial "github.com/karmaKiller3352/Xray-core/common/serial"
...
// APIAuth configuration for external UUID validation
type APIAuth struct {
...
func (x *APIAuth) GetEnabled() bool {
	if x != nil {
		return x.Enabled
	}
	return false
...
type Config struct {
	...
	// API authentication configuration for external UUID validation
	ApiAuth       *APIAuth `protobuf:"bytes,7,opt,name=api_auth,json=apiAuth,proto3" json:"api_auth,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Config) GetApiAuth() *APIAuth {
	if x != nil {
		return x.ApiAuth
	}
	return nil
...
func (x *OutboundHandlerConfig) Reset() {
	*x = OutboundHandlerConfig{}
	mi := &file_core_config_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*OutboundHandlerConfig) Descriptor() ([]byte, []int) {
	return file_core_config_proto_rawDescGZIP(), []int{3}
}
...
const file_core_config_proto_rawDesc = "" +
	"\n" +
	"\x11core/config.proto\x12\txray.core\x1a!common/serial/typed_message.proto\"5\n" +
	"\aAPIAuth\x12\x18\n" +
	...
	"\textension\x18\x06 \x03(\v2 .xray.common.serial.TypedMessageR\textension\x12-\n" +
	"\bapi_auth\x18\a \x01(\v2\x12.xray.core.APIAuthR\aapiAuthJ\x04\b\x03\x10\x04\"\xc0\x01\n" +
	...
	"\acomment\x18\x05 \x01(\tR\acommentBH\n" +
	"\rcom.xray.coreP\x01Z)github.com/karmaKiller3352/Xray-core/core\xaa\x02\tXray.Coreb\x06proto3"
...
var file_core_config_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_core_config_proto_goTypes = []any{
	(*APIAuth)(nil),               // 0: xray.core.APIAuth
	(*Config)(nil),                // 1: xray.core.Config
	(*InboundHandlerConfig)(nil),  // 2: xray.core.InboundHandlerConfig
	(*OutboundHandlerConfig)(nil), // 3: xray.core.OutboundHandlerConfig
	(*serial.TypedMessage)(nil),   // 4: xray.common.serial.TypedMessage
}
var file_core_config_proto_depIdxs = []int32{
	2, // 0: xray.core.Config.inbound:type_name -> xray.core.InboundHandlerConfig
	3, // 1: xray.core.Config.outbound:type_name -> xray.core.OutboundHandlerConfig
	4, // 2: xray.core.Config.app:type_name -> xray.common.serial.TypedMessage
	4, // 3: xray.core.Config.extension:type_name -> xray.common.serial.TypedMessage
	0, // 4: xray.core.Config.api_auth:type_name -> xray.core.APIAuth
	4, // 5: xray.core.InboundHandlerConfig.receiver_settings:type_name -> xray.common.serial.TypedMessage
	4, // 6: xray.core.InboundHandlerConfig.proxy_settings:type_name -> xray.common.serial.TypedMessage
	4, // 7: xray.core.OutboundHandlerConfig.sender_settings:type_name -> xray.common.serial.TypedMessage
	4, // 8: xray.core.OutboundHandlerConfig.proxy_settings:type_name -> xray.common.serial.TypedMessage

...
const file_app_router_command_command_proto_rawDesc = "" +
	...
	"\n" +
	"RemoveRule\x12*.xray.app.router.command.RemoveRuleRequest\x1a+.xray.app.router.command.RemoveRuleResponse\"\x00Br\n" +
	"\x1bcom.xray.app.router.commandP\x01Z7github.com/karmaKiller3352/Xray-core/app/router/command\xaa\x02\x17Xray.App.Router.Commandb\x06proto3"
